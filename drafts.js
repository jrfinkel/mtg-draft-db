...
function finalStep (body, response) {
	...
	for (var i=0; i<2; i++) {
		...
		b += '<tr><td align="center">'+player.name+'<td align="center"><input type="hidden" name="player'+playerNum+'" value='+player.id+'><input type="text" name="money'+playerNum+'" value="'+money+'" size="3"><td align=center><input type="text" name="set_credit'+playerNum+'" value="-3" size="3">';
		playerNum++;
